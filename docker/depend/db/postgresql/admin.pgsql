...
ALTER TABLE public.goadmin_menu_myid_seq
    OWNER TO postgres;
...
ALTER TABLE public.goadmin_operation_log_myid_seq
    OWNER TO postgres;
...
ALTER TABLE public.goadmin_permissions_myid_seq
    OWNER TO postgres;
...
ALTER TABLE public.goadmin_permissions
    OWNER TO postgres;
...
ALTER TABLE public.goadmin_role_menu
    OWNER TO postgres;
...
ALTER TABLE public.goadmin_role_permissions
    OWNER TO postgres;
...
ALTER TABLE public.goadmin_role_users
    OWNER TO postgres;
...
ALTER TABLE public.goadmin_roles_myid_seq
    OWNER TO postgres;
...
ALTER TABLE public.goadmin_roles
    OWNER TO postgres;
...
ALTER TABLE public.goadmin_session_myid_seq
    OWNER TO postgres;
...
ALTER TABLE public.goadmin_session
    OWNER TO postgres;
...
ALTER TABLE public.goadmin_user_permissions
    OWNER TO postgres;
...
ALTER TABLE public.goadmin_users_myid_seq
    OWNER TO postgres;
